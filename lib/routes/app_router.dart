...
import '../screens/groups/group_administrators_screen.dart';
import '../screens/groups/group_leave_screen.dart';
import '../screens/groups/group_manage_members_screen.dart';
...
///
/// La navigation utilise la pile Navigator standard afin que
/// chaque écran puisse revenir naturellement à l'écran précédent.
class AppRouter {
  AppRouter._();
  ...
  static Route<dynamic> onGenerateRoute(
    ...
    switch (settings.name) {
      ...
      case AppRoutes.groupeChoice:
        ...
        return _page(
          GroupeChoiceScreen(
            depuisGroupesScreen: depuisGroupes,
          ),
        );
      ...
      case AppRoutes.groupManageMembers:
        return _page(
          const GroupManageMembersScreen(),
        );

      case AppRoutes.groupAdministrators:
        return _page(
          const GroupAdministratorsScreen(),
        );

      case AppRoutes.groupLeave:
        return _page(
